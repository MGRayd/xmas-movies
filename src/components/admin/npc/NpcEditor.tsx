...
import BasicFields from "@/components/admin/npc/BasicFields";
...
import NpcRelations from "@/components/admin/npc/NpcRelations";
import DeceasedToggle from "@/components/admin/npc/DeceasedToggle";
import { Option } from "@/components/RelationPicker";
import { useToast } from "@/ui/ToastProvider";

type AnyMap = Record<string, any>;

export default function NpcEditor({ mode }: { mode: "create" | "edit" }) {
  const { id } = useParams();
  const col = "npcs";
  ...
  async function save() {
    ...
    try {
      ...
      console.error(e);
      // ❌ error toast
      toast.error(e?.message || "Failed to save NPC.");
    }
  }
